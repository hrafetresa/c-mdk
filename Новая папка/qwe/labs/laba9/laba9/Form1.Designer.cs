namespace _laba9
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.параметрыФормыToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.гласныеToolStripMenuItem.Size = new System.Drawing.Size(135, 22);
            ...
            this.согласныеToolStripMenuItem.Size = new System.Drawing.Size(135, 22);
            ...
            this.заглавныеToolStripMenuItem.Size = new System.Drawing.Size(135, 22);
            ...
            this.строчныеToolStripMenuItem.Size = new System.Drawing.Size(135, 22);
            ...
            this.параметрыФормыToolStripMenuItem});
            ...
            // 
            this.показатьскрытьПанельИнструментовToolStripMenuItem.Checked = true;
            this.показатьскрытьПанельИнструментовToolStripMenuItem.CheckOnClick = true;
            this.показатьскрытьПанельИнструментовToolStripMenuItem.CheckState = System.Windows.Forms.CheckState.Checked;
            this.показатьскрытьПанельИнструментовToolStripMenuItem.Name = "показатьскрытьПанельИнструментовToolStripMenuItem";
            this.показатьскрытьПанельИнструментовToolStripMenuItem.Size = new System.Drawing.Size(291, 22);
            this.показатьскрытьПанельИнструментовToolStripMenuItem.Text = "Показать/скрыть панель инструментов";
            this.показатьскрытьПанельИнструментовToolStripMenuItem.CheckedChanged += new System.EventHandler(this.показатьскрытьПанельИнструментовToolStripMenuItem_CheckedChanged);
            // 
            // параметрыФормыToolStripMenuItem
            // 
            this.параметрыФормыToolStripMenuItem.Name = "параметрыФормыToolStripMenuItem";
            this.параметрыФормыToolStripMenuItem.Size = new System.Drawing.Size(291, 22);
            this.параметрыФормыToolStripMenuItem.Text = "Параметры формы";
            this.параметрыФормыToolStripMenuItem.Click += new System.EventHandler(this.параметрыФормыToolStripMenuItem_Click);
            // 
            // label1
            // 
        ...
        private System.Windows.Forms.ToolStripMenuItem параметрыФормыToolStripMenuItem;
